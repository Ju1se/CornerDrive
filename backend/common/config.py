...
# ============ L1: LINEAR DEFENSE ============
L1_HOST = os.getenv("L1_HOST", "0.0.0.0")
...
# ============ L4: SETTLEMENT ============
L4_DASHBOARD_HOST = os.getenv("L4_DASHBOARD_HOST", "0.0.0.0")
...
# ============ SECURITY ============
VALID_API_KEYS = os.getenv("VALID_API_KEYS", "dev_key_1,dev_key_2").split(",")
